...
from packages.mmcv.config import Config
...
ClassificationDataset, ClassificationCollator, FastTextCollator, FastText, TextCNN, TextRNN, TextRCNN, DRNN, TextVDCNN, Transformer, DPCNN, AttentiveConvNet, RegionEmbedding, HMCN
...
class Predictor(object):
    ...
    def _load_checkpoint(file_name, model, use_cuda):
        ...
        checkpoint["state_dict"].pop("linear.weight")
...
if __name__ == "__main__":
    ...
    with codecs.open(os.path.join(config.eval.pred_prefix, "predict.txt"), "w", predictor.dataset.CHARSET) as of:
